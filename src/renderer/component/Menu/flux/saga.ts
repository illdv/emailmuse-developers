...
export function* menuSaga(action): IterableIterator<any> {
    ...
    switch (action.payload.selectedItem) {
      case MenuItemType.ACCOUNT: route = '/emails'; break;
      case MenuItemType.IMAGE_LIBRARY: route = '/image-library'; break;
      case MenuItemType.LAYOUTS: route = '/layouts'; break;
      case MenuItemType.SNIPPETS: route = '/snippets'; break;
      case MenuItemType.SWIPE: route = '/swipe'; break;
      case MenuItemType.TEMPLATES: route = '/emails'; break;
      default: route = '/';
    }
