...
class PaperDialog extends Component<
  PaperDialogSpace.IProps & WithStyles<any>,
  PaperDialogSpace.IState
> {
  state = { value: '' };
  ...
  static getDerivedStateFromProps(
    ...
    prevState: PaperDialogSpace.IState,
  ): PaperDialogSpace.IState {
          ...
          <Grid container spacing={24} className={classes.root}>
            ...
            <Grow in timeout={1000}>
              <Grid container item xs={12} style={{ paddingTop: 0 }}>
                ...
                <Button className={classes.button} onClick={this.onSendNewCode}>
                  Send new code
                </Button>
              </Grid>
            </Grow>
